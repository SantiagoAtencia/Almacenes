    ...
    def menu(self):
        while True:
            ...
            if opcion == "1":
                ...
                self.añadir_objeto(nombre, cantidad)
            elif opcion == "2":
                nombre = input("Nombre del objeto: ")
                cantidad = int(input("Cantidad: "))
                self.reservar_objeto(nombre, cantidad)
            elif opcion == "3":
                nombre = input("Nombre del objeto: ")
                cantidad = int(input("Cantidad: "))
                self.sacar_objeto(nombre, cantidad)
            elif opcion == "4":
                nombre = input("Nombre del objeto: ")
                cantidad = int(input("Cantidad: "))
                self.sacar_reserva(nombre, cantidad)
            elif opcion == "5":
                nombre = input("Nombre del objeto: ")
                cantidad = int(input("Cantidad: "))
                self.cancelar_reserva(nombre, cantidad)
            elif opcion == "6":
                nombre = input("Nombre del objeto: ")
                self.get_item_quantity(nombre)
            elif opcion == "7":
                self.ver_inventario()
            elif opcion == "8":
                nombre = input("Nuevo nombre de la base de datos: ")
                self.cambiar_base_datos(nombre)
            elif opcion == "9":
